...
final int COLOR_MAX = 255; // don't change this
...
final float NOISE_INF = 0.25; // strength of vectors created by noise
...
final float SQRT3 = sqrt(3); // magnitude of a unit-diagonal vector (1,1,1)
